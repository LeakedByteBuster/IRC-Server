...
void                       check_targets(std::map<std::string,channel> channels,std::vector<std::string>commmand,std::vector<std::string> params,Client clt,std::map<int,Client> clients);
